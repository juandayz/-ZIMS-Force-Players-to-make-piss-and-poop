...
s_player_makepiss = player addAction [("<t color=""#FFFF66"">" + ("Make Pee") + "</t>"), "scripts\zims\pisspoo.sqf"];};
} else {
...
s_player_makepoo = player addAction [("<t color=""#663300"">" + ("Make Poop") + "</t>"), "scripts\zims\pisspoo.sqf"];};
} else {
